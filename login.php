...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Authentication (adapted for plain text password if you don't use password_hash)
        if ($userFound && ($password === $userFound['password'])) { 
            $_SESSION['user_id'] = $userFound['id'];
            $_SESSION['user_name'] = $userFound['name'];
            $message = "Login successful! Welcome " . htmlspecialchars($userFound['name']) . "!";
            $messageType = "success";
